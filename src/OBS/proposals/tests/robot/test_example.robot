...
#
#  $ bin/test -s OBS.proposals -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src OBS.proposals.testing.OBS_PROPOSALS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/OBS/proposals/tests/robot/test_example.robot
#
